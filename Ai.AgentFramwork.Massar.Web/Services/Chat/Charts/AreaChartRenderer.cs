...
/// <summary>Area chart (filled under the line).</summary>
public sealed class AreaChartRenderer
{
        ...
        int height = 350)
    {
        ...
        using var fillPaint = new SKPaint { IsAntialias = true, Color = new SKColor(60, 110, 200, 70), Style = SKPaintStyle.Fill };
        ...
        var labelRotation = 90f; // +90 => text goes downward from the axis
        var labelYOffset = 10f;  // distance below the x-axis line
        ...
        for (int i = 0; i < n; i++)
        {
            ...
            else
            {
                ...
                // Keep the label below the axis and avoid clipping due to left bearings
