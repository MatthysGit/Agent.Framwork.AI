...
1. In Visual Studio, right-click on the Ai.AgentFramwork.Massar.AppHost project in the Solution Explorer and select "Manage User Secrets".
...
3. Once installed, Open the `Program.cs` file in the Ai.AgentFramwork.Massar.AppHost project.
...
This template leverages JavaScript libraries to provide essential functionality. These libraries are located in the wwwroot/lib folder of the Ai.AgentFramwork.Massar.Web project. For instructions on updating each dependency, please refer to the README.md file in each respective folder.
